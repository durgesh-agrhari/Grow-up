  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/css-basic' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: Css Basic Questions</p>
            </NavLink>

            <NavLink to='/Css-Importent-Questoins' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp Css Questions</p>
            </NavLink> 
