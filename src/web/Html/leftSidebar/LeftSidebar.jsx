  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/html-basic' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: HTML Basic Questions</p>
            </NavLink>

            <NavLink to='/Importent-html-basic-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp HTML Questions</p>
            </NavLink> 
