    ...
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/javascript' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: JavaScript Basic Questions</p>
            </NavLink>

            <NavLink to='/Importent-Javascript-Questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp JavaScript Questions</p>
            </NavLink> 
