  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/Redux-Basic-Concept' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: Redux Basic Questions</p>
            </NavLink>

            <NavLink to='/Importent-html-basic-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Importent Redux Questions</p>
            </NavLink> 
