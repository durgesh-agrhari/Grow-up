  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/DBMS-Basic-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: DBMS Basic Questions</p>
            </NavLink>

            <NavLink to='/DBMS-Importent-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp DBMS Questions</p>
            </NavLink> 
