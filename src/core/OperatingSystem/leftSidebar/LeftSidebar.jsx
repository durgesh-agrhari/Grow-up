  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/Operating-System-Basic-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: Os Basic</p>
            </NavLink>

            <NavLink to='/Importent-Operating-System-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp OS Questions</p>
            </NavLink> 
