  ...
  return (
    <div className='left-sidebsr' >
        <nav className='side-nav' >
            ...
            <NavLink to='/Mysql-Basic-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1'>0: Mysql Basic Questions</p>
            </NavLink>

            <NavLink to='/Mysql-Importent-questions' className='side-nav-links' activeClassName='active'>
                <p className='active1' >1: Imp Mysql Questions</p>
            </NavLink> 
