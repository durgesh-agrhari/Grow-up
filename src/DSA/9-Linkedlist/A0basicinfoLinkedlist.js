...
const A0basicinfoLinkedlist = () => {
  return (
    <div className='subb'>
      <Helmet>
        <title>Linkedlist Basic Questions</title>
    ...
    <div className='home-container1'>
      ...
      <div className='home-container2'>
        ...
        <h2 className='s'> <u> -: Linkedlist :- </u></h2>
      
        <h3>What is Linkedlist ? </h3><br/>
...
export default A0basicinfoLinkedlist
